...
Joueur.decrire = function () {
    var description = this.nom + " a " + this.sante + " points de vie, " +
        this.force + " en force et " + this.xp + " points d'expérience, " + this.or + " pièces d'or et " + this.clef + " clé(s)";
    return description;
};
...
joueur2.initJoueur("Glacius", 80, 30);
...
monstre.initAdversaire("ZogZog", 40, 30, "orc", 10);
